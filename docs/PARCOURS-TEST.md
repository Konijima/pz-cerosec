...
Elle ne change que quatre choses : allumer, éteindre, où le personnage se
trouve, et — derrière deux clics, et seulement sur une machine éteinte —
**réinitialiser la machine**, c'est-à-dire en refaire une que personne n'a jamais
utilisée. Tout le reste est en lecture. Détails et protocole dans
[DEBUG.md](DEBUG.md).
